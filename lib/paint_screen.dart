...
import 'package:skribble_clone/sidebar/player_scoreboard_drawer.dart';
...
class _PaintScreenState extends State<PaintScreen> {
  ...
  void connect() {
    _socket = io.io('http://192.168.202.219:3000', <String, dynamic>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: dataOfRoom.isNotEmpty
